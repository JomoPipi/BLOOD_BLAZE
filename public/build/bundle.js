    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 15, 26, 469);
    			add_location(h4, file$4, 14, 12, 437);
    			attr_dev(input0, "type", "hidden");
    			attr_dev(input0, "name", "hosted_button_id");
    			input0.value = "NH4KDT52XGUTN";
    			add_location(input0, file$4, 18, 16, 710);
    			...
    			add_location(input1, file$4, 19, 16, 797);
    			attr_dev(img, "alt", "");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$3, 48, 0, 1491);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
