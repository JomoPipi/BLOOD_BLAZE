    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(center, file$1, 51, 0, 2012);
    			attr_dev(div0, "class", "scoreboard svelte-cooxpp");
    			add_location(div0, file$1, 52, 0, 2041);
    			attr_dev(canvas_1, "class", "svelte-cooxpp");
    			add_location(canvas_1, file$1, 53, 0, 2096);
    			attr_dev(div1, "class", "input-container svelte-cooxpp");
    			add_location(div1, file$1, 54, 0, 2126);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
