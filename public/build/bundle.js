...
var app = (function () {
    ...
    */
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<Joystick> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(center, file, 49, 0, 1623);
    			attr_dev(canvas_1, "class", "svelte-oc4qsm");
    			add_location(canvas_1, file, 50, 0, 1652);
    			attr_dev(div, "class", "svelte-oc4qsm");
    			add_location(div, file, 51, 0, 1682);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
