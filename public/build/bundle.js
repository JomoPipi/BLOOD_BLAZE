    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$3, 88, 4, 2576);
    			attr_dev(div, "class", "svelte-18l9nl");
    			add_location(div, file$3, 87, 0, 2544);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 18, 12, 590);
    			attr_dev(h4, "class", "svelte-1p5603t");
    			add_location(h4, file$2, 19, 12, 660);
    			attr_dev(label, "class", "svelte-1p5603t");
    			add_location(label, file$2, 17, 8, 570);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 8, 0, 312);
    			add_location(button1, file$2, 12, 4, 459);
    			attr_dev(div, "class", "settings-page svelte-1p5603t");
    			toggle_class(div, "show", /*settingsPage*/ ctx[1].isOpen);
    			add_location(div, file$2, 11, 0, 394);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(center, file$1, 22, 0, 825);
    			attr_dev(div0, "class", "scoreboard svelte-cooxpp");
    			add_location(div0, file$1, 23, 0, 853);
    			attr_dev(canvas_1, "class", "svelte-cooxpp");
    			add_location(canvas_1, file$1, 24, 0, 907);
    			attr_dev(div1, "class", "input-container svelte-cooxpp");
    			add_location(div1, file$1, 25, 0, 936);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 20, 1, 556);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-yuxzpj");
    			add_location(div, file, 13, 0, 391);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
