...
var app = (function () {
    ...
    class Nomination extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { proceed: 2, blaze: 0, socket: 3 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas, "class", "svelte-gqnlz3");
    			add_location(canvas, file, 6, 0, 109);
    			add_location(br, file, 8, 0, 142);
    			attr_dev(button0, "class", "svelte-gqnlz3");
    			add_location(button0, file, 10, 4, 159);
    			attr_dev(button1, "class", "svelte-gqnlz3");
    			add_location(button1, file, 11, 4, 183);
    			attr_dev(div, "class", "svelte-gqnlz3");
    			add_location(div, file, 9, 0, 148);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ socket, username });
