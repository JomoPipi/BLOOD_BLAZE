...
var app = (function () {
    ...
    const file$3 = "src\\Nomination.svelte";
    ...
    const file$2 = "src\\uielements\\DirectionPad.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas_1, "class", "svelte-1jfe5w3");
    			add_location(canvas_1, file$2, 45, 0, 1255);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\uielements\JoyPad.svelte generated by Svelte v3.38.2 */

    const { console: console_1$1 } = globals;
    const file$1 = "src\\uielements\\JoyPad.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			canvas_1 = element("canvas");
    			attr_dev(canvas_1, "class", "svelte-udzzl4");
    			add_location(canvas_1, file$1, 86, 4, 2651);
    			attr_dev(div, "class", "svelte-udzzl4");
    			add_location(div, file$1, 85, 0, 2618);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		W = $$invalidate(1, canvas.width = H = $$invalidate(1, canvas.height = size1, canvas), canvas);
    		$$invalidate(0, container.style.width = size + "px", container);
    		$$invalidate(0, container.style.height = size + "px", container);
    		const d = size * (PHI - 1) | 0;
    		$$invalidate(1, canvas.style.left = $$invalidate(1, canvas.style.top = (-d / 2 | 0) + "px", canvas), canvas);
    ...
    */
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<JoyPad> was created with unknown prop '${key}'`);
    	});
    ...
    class JoyPad extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get callback() {
    		throw new Error("<JoyPad>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set callback(value) {
    		throw new Error("<JoyPad>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    const file = "src\\GameClient.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	joypad = new JoyPad({
    			props: { callback: /*moveLeftJoyPad*/ ctx[2] },
    			$$inline: true
    		});

    	directionpad = new DirectionPad({
    			props: { callback: /*moveRightPad*/ ctx[3] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			div = element("div");
    			create_component(joypad.$$.fragment);
    			t3 = space();
    			create_component(directionpad.$$.fragment);
    			attr_dev(center, "class", "svelte-oc4qsm");
    			add_location(center, file, 50, 0, 1635);
    			attr_dev(canvas_1, "class", "svelte-oc4qsm");
    			add_location(canvas_1, file, 51, 0, 1664);
    			attr_dev(div, "class", "svelte-oc4qsm");
    		...
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, div, anchor);
    			mount_component(joypad, div, null);
    			append_dev(div, t3);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(joypad.$$.fragment, local);
    			transition_in(directionpad.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(joypad.$$.fragment, local);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		socket.on("renderGameLoop", ([players, bullets]) => {
    			...
    			Object.keys(players).forEach(username => {
    				...
    				const [X, Y] = [x + playerSize * Math.cos(p.angle), y + playerSize * Math.sin(p.angle)];
    	...
    	return [username, canvas, moveLeftJoyPad, moveRightPad, socket, canvas_1_binding];
    }

    class GameClient extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { socket: 4, username: 0 });
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(14:0) {#if username.length === 0}",
    		ctx
    	});
