    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "_1 svelte-q5dme9");
    			add_location(span0, file$9, 49, 3, 1375);
    			attr_dev(span1, "class", "_2 svelte-q5dme9");
    			add_location(span1, file$9, 50, 3, 1412);
    			attr_dev(h1, "class", "svelte-q5dme9");
    			add_location(h1, file$9, 48, 2, 1365);
    			attr_dev(h2, "class", "svelte-q5dme9");
    			add_location(h2, file$9, 52, 2, 1458);
    			attr_dev(span2, "class", "title svelte-q5dme9");
    			add_location(span2, file$9, 47, 1, 1341);
    			attr_dev(input, "autocomplete", "off");
    			attr_dev(input, "placeholder", "Enter something here...");
    			attr_dev(input, "pattern", "[A-Za-z0-9 _]*");
    			attr_dev(input, "maxlength", /*charLimit*/ ctx[3]);
    			attr_dev(input, "class", "svelte-q5dme9");
    			add_location(input, file$9, 56, 3, 1609);
    			attr_dev(button, "class", "svelte-q5dme9");
    			add_location(button, file$9, 62, 3, 1799);
    			attr_dev(h3, "class", "svelte-q5dme9");
    			add_location(h3, file$9, 63, 3, 1825);
    			attr_dev(form, "type", "text");
    			attr_dev(form, "action", "");
    			add_location(form, file$9, 55, 2, 1552);
    			add_location(span3, file$9, 65, 1, 1874);
    			attr_dev(bloodblaze, "class", "svelte-q5dme9");
    			add_location(bloodblaze, file$9, 66, 1, 1884);
    			attr_dev(span4, "class", "inner svelte-q5dme9");
    			add_location(span4, file$9, 54, 1, 1528);
    			attr_dev(main, "class", "svelte-q5dme9");
    			add_location(main, file$9, 46, 0, 1332);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 30, 4, 1103);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$1, 27, 4, 1042);
    			attr_dev(center, "class", "svelte-w51t2q");
    			add_location(center, file$1, 25, 0, 977);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 26, 1, 898);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-12em62w");
    			add_location(div, file, 19, 0, 717);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
