...
var app = (function () {
    ...
    const file$5 = "src/game/Nomination.svelte";
    ...
    const file$4 = "src/uielements/DirectionPad.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$4, 45, 0, 1226);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/uielements/Joystick.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$3, 88, 4, 2575);
    			attr_dev(div, "class", "svelte-18l9nl");
    			add_location(div, file$3, 87, 0, 2543);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    /* src/game/DevSwitches.svelte generated by Svelte v3.38.2 */

    const { Object: Object_1$1 } = globals;
    const file$2 = "src/game/DevSwitches.svelte";
    ...
    // (16:4) {#each devSwitches() as option}
    function create_each_block(ctx) {
    	let label;
    	let input;
    	let t0;
    	let h4;
    	let t1_value = /*option*/ ctx[4].split(camelCase).map(func).join(" ") + "";
    	let t1;
    	let t2;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 17, 12, 590);
    			attr_dev(h4, "class", "svelte-1p5603t");
    			add_location(h4, file$2, 18, 12, 660);
    			attr_dev(label, "class", "svelte-1p5603t");
    			add_location(label, file$2, 16, 8, 570);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*DEV_SETTINGS, devSwitches*/ 5) {
    				input.checked = /*DEV_SETTINGS*/ ctx[0][/*option*/ ctx[4]];
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:4) {#each devSwitches() as option}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*devSwitches*/ ctx[2]();
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 7, 0, 311);
    			add_location(button1, file$2, 11, 4, 458);
    			attr_dev(div, "class", "settings-page svelte-1p5603t");
    			toggle_class(div, "show", /*settingsPage*/ ctx[1].isOpen);
    			add_location(div, file$2, 10, 0, 393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*devSwitches, camelCase, DEV_SETTINGS*/ 5) {
    				each_value = /*devSwitches*/ ctx[2]();
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [DEV_SETTINGS, settingsPage, devSwitches, input_change_handler];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	let joystick;
    	let t4;
    	let show_if = /*devMode*/ ctx[5]();
    	let t5;
    	let directionpad;
    	let current;

    	joystick = new Joystick({
    			props: { callback: /*moveJoystick*/ ctx[3] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(center, file$1, 127, 0, 5295);
    			attr_dev(div0, "class", "scoreboard svelte-cooxpp");
    			add_location(div0, file$1, 128, 0, 5323);
    			attr_dev(canvas_1, "class", "svelte-cooxpp");
    			add_location(canvas_1, file$1, 129, 0, 5377);
    			attr_dev(div1, "class", "input-container svelte-cooxpp");
    			add_location(div1, file$1, 130, 0, 5406);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	onMount(() => {
    		...
    		socket.on("gameTick", msg => {
    			...
    			for (const p of msg.players) {
    				...
    				(_a = state.players)[_b = p.name] || (_a[_b] = new Player(p));
    		...
    		(function updateLoop() {
    			...
    			$$invalidate(2, scoreboard.innerHTML = Object.values(state.players).sort((p1, p2) => p2.data.score - p1.data.score).map(p => `<span style="color: orange">${p.data.name}:</span> ${p.data.score}`).join("<br>") + `<br> pending requests: ${state.pendingInputs.length}` + `<br> network latency: ${NETWORK_LATENCY.value}`, scoreboard);
    			renderer.render(now);
    		})();
    	});
    ...
    class GameClient extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { socket: 6, username: 0 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-yuxzpj");
    			add_location(div, file, 13, 0, 379);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
