    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$3, 46, 0, 1315);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$2, 86, 4, 2651);
    			attr_dev(div, "class", "svelte-udzzl4");
    			add_location(div, file$2, 85, 0, 2618);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(center, "class", "svelte-oz1p0d");
    			add_location(center, file$1, 67, 0, 2649);
    			attr_dev(div0, "class", "scoreboard svelte-oz1p0d");
    			add_location(div0, file$1, 68, 0, 2678);
    			attr_dev(canvas_1, "class", "svelte-oz1p0d");
    			add_location(canvas_1, file$1, 69, 0, 2733);
    			attr_dev(div1, "class", "input-container svelte-oz1p0d");
