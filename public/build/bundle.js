    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "_1 svelte-8uflbo");
    			add_location(span0, file$9, 49, 3, 1375);
    			attr_dev(span1, "class", "_2 svelte-8uflbo");
    			add_location(span1, file$9, 50, 3, 1412);
    			attr_dev(h1, "class", "svelte-8uflbo");
    			add_location(h1, file$9, 48, 2, 1365);
    			attr_dev(h2, "class", "svelte-8uflbo");
    			add_location(h2, file$9, 52, 2, 1458);
    			attr_dev(span2, "class", "title svelte-8uflbo");
    			...
    			attr_dev(input, "class", "svelte-8uflbo");
    			add_location(input, file$9, 56, 3, 1609);
    			attr_dev(button, "class", "svelte-8uflbo");
    			add_location(button, file$9, 62, 3, 1791);
    			attr_dev(form, "type", "text");
    			attr_dev(form, "action", "");
    			add_location(form, file$9, 55, 2, 1552);
    			add_location(span3, file$9, 64, 1, 1826);
    			attr_dev(bloodblaze, "class", "svelte-8uflbo");
    			add_location(bloodblaze, file$9, 65, 1, 1836);
    			attr_dev(span4, "class", "inner svelte-8uflbo");
    			add_location(span4, file$9, 54, 1, 1528);
    			attr_dev(main, "class", "svelte-8uflbo");
