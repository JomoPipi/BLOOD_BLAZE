    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$7, 43, 3, 1213);
    			attr_dev(span1, "class", "_2 svelte-151gubb");
    			add_location(span1, file$7, 44, 3, 1250);
    			attr_dev(h1, "class", "svelte-151gubb");
    			add_location(h1, file$7, 42, 2, 1203);
    			attr_dev(h2, "class", "svelte-151gubb");
    			add_location(h2, file$7, 46, 2, 1296);
    			attr_dev(span2, "class", "title svelte-151gubb");
    			add_location(span2, file$7, 41, 1, 1179);
    			...
    			add_location(input, file$7, 50, 3, 1447);
    			attr_dev(button, "class", "svelte-151gubb");
    			add_location(button, file$7, 56, 3, 1629);
    			attr_dev(form, "type", "text");
    			attr_dev(form, "action", "");
    			add_location(form, file$7, 49, 2, 1390);
    			add_location(span3, file$7, 58, 1, 1664);
    			attr_dev(bloodblaze, "class", "svelte-151gubb");
    			add_location(bloodblaze, file$7, 59, 1, 1674);
    			attr_dev(span4, "class", "inner svelte-151gubb");
    			add_location(span4, file$7, 48, 1, 1366);
    			attr_dev(main, "class", "svelte-151gubb");
    			add_location(main, file$7, 40, 0, 1170);
    		},
