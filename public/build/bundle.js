...
var app = (function () {
    ...
    const file$a = "src\\game\\views\\Title\\BoundlessMortality.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-n3dkpd");
    			add_location(h2, file$a, 1, 0, 2);
    		},
    ...
    const file$9 = "src\\game\\views\\Title\\Title.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$9, 49, 2, 1411);
    			attr_dev(span1, "class", "_2 svelte-13efgdb");
    			add_location(span1, file$9, 50, 2, 1447);
    			attr_dev(h1, "class", "svelte-13efgdb");
    			add_location(h1, file$9, 48, 1, 1402);
    			...
    			add_location(input, file$9, 55, 3, 1582);
    			attr_dev(button, "class", "svelte-13efgdb");
    			add_location(button, file$9, 61, 3, 1768);
    			attr_dev(h3, "class", "svelte-13efgdb");
    			add_location(h3, file$9, 62, 3, 1794);
    			attr_dev(form, "type", "text");
    			attr_dev(form, "action", "");
    			add_location(form, file$9, 54, 2, 1525);
    			add_location(div, file$9, 52, 1, 1491);
    			attr_dev(bloodblaze, "class", "svelte-13efgdb");
    			add_location(bloodblaze, file$9, 65, 1, 1852);
    			attr_dev(main, "class", "svelte-13efgdb");
    			add_location(main, file$9, 47, 0, 1393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Title extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*proceed*/ ctx[5] === undefined && !("proceed" in props)) {
    			console.warn("<Title> was created without expected prop 'proceed'");
    		}

    		if (/*blaze*/ ctx[0] === undefined && !("blaze" in props)) {
    			console.warn("<Title> was created without expected prop 'blaze'");
    		}

    		if (/*socket*/ ctx[6] === undefined && !("socket" in props)) {
    			console.warn("<Title> was created without expected prop 'socket'");
    		}
    	}
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$8, 48, 0, 1491);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$7, 88, 4, 2761);
    			attr_dev(div, "id", "mobile-game-joystick");
    			attr_dev(div, "class", "svelte-9dbomt");
    			add_location(div, file$7, 87, 0, 2704);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    const file$6 = "src\\game\\views\\Score.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$6, 20, 0, 523);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Score extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { name: 0, value: 1, maximum: 3 });
    ...
    const file$5 = "src\\game\\views\\Scoreboard.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 8, 0, 270);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Scoreboard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { updateScoreboard: 1 });
        ...
        processGameTick(msg) {
            ...
            for (const b of msg.newBullets) {
                ...
                if (DEV_SETTINGS.showExtrapolatedEnemyPositions) {
                    const display = { x: (player.lastExtrapolatedPosition.x + CONSTANTS.PLAYER_RADIUS * Math.cos(p.angle)) * this.width,
    ...
    const file$4 = "src\\game\\uielements\\PageButton.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$4, 6, 0, 178);
    			add_location(button1, file$4, 11, 4, 338);
    ...
    class PageButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { btnText: 0 });
    ...
    const file$3 = "src\\game\\views\\DevSwitches.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text(t3_value);
    			t4 = space();
    			add_location(br0, file$3, 9, 8, 419);
    			add_location(br1, file$3, 10, 8, 434);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file$3, 12, 12, 470);
    			attr_dev(h4, "class", "svelte-1ppm1ft");
    			add_location(h4, file$3, 13, 12, 541);
    			add_location(label, file$3, 11, 8, 449);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	joystick = new Joystick({
    			props: {
    				callback: /*inputs*/ ctx[5].moveJoystick.bind(/*inputs*/ ctx[5])
    			},
    			$$inline: true
    		});
    	...
    	directionpad = new DirectionPad({
    			props: {
    				callback: /*inputs*/ ctx[5].adjustAim.bind(/*inputs*/ ctx[5])
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 34, 4, 1238);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	if (/*updateScoreboard*/ ctx[4] !== void 0) {
    		scoreboard_props.updateScoreboard = /*updateScoreboard*/ ctx[4];
    	}
    	...
    	let if_block = /*isMobile*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$1, 31, 4, 1177);
    			attr_dev(center, "class", "svelte-w51t2q");
    			add_location(center, file$1, 29, 0, 1112);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_updateScoreboard && dirty & /*updateScoreboard*/ 16) {
    				updating_updateScoreboard = true;
    				scoreboard_changes.updateScoreboard = /*updateScoreboard*/ ctx[4];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 26, 1, 889);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-12em62w");
    			add_location(div, file, 19, 0, 713);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
