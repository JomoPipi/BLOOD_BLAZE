...
var app = (function () {
    ...
    */
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 18, 12, 589);
    			attr_dev(h4, "class", "svelte-1p5603t");
    			add_location(h4, file$2, 19, 12, 659);
    			attr_dev(label, "class", "svelte-1p5603t");
    			add_location(label, file$2, 17, 8, 569);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 8, 0, 311);
    			add_location(button1, file$2, 12, 4, 458);
    			attr_dev(div, "class", "settings-page svelte-1p5603t");
    			toggle_class(div, "show", /*settingsPage*/ ctx[1].isOpen);
    			add_location(div, file$2, 11, 0, 393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(center, file$1, 87, 0, 3559);
    			attr_dev(div0, "class", "scoreboard svelte-cooxpp");
    			add_location(div0, file$1, 88, 0, 3587);
    			attr_dev(canvas_1, "class", "svelte-cooxpp");
    			add_location(canvas_1, file$1, 89, 0, 3641);
    			attr_dev(div1, "class", "input-container svelte-cooxpp");
    			add_location(div1, file$1, 90, 0, 3670);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		ctx = canvas.getContext("2d");
    		$$invalidate(1, canvas.height = $$invalidate(1, canvas.width = window.innerWidth, canvas), canvas);
