...
var app = (function () {
    ...
    const file$2 = "src\\Nomination.svelte";
    ...
    class Nomination extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { proceed: 2, blaze: 0, socket: 3 });
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		W = H = $$invalidate(0, canvas.width = $$invalidate(0, canvas.height = size, canvas), canvas);
    		...
    		$$invalidate(0, canvas.ontouchmove = mousemove, canvas);
    ...
    function create_fragment$1(ctx) {
    	...
    	let joypad1;
    	let current;
    	joypad0 = new JoyPad({ $$inline: true });
    	joypad1 = new JoyPad({ $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, t3);
    			mount_component(joypad1, div, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(joypad0.$$.fragment, local);
    			transition_in(joypad1.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(joypad0.$$.fragment, local);
    			transition_out(joypad1.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ JoyPad, socket, username });
    ...
    class GameClient extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { socket: 1, username: 0 });
