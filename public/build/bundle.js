...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$7, 40, 3, 1127);
    			attr_dev(span1, "class", "_2 svelte-151gubb");
    			add_location(span1, file$7, 41, 3, 1164);
    			attr_dev(h1, "class", "svelte-151gubb");
    			add_location(h1, file$7, 39, 2, 1117);
    			attr_dev(h2, "class", "svelte-151gubb");
    			add_location(h2, file$7, 43, 2, 1210);
    			attr_dev(span2, "class", "title svelte-151gubb");
    			add_location(span2, file$7, 38, 1, 1093);
    			...
    			add_location(input, file$7, 47, 3, 1361);
    			attr_dev(button, "class", "svelte-151gubb");
    			add_location(button, file$7, 53, 3, 1543);
    			attr_dev(form, "type", "text");
    			attr_dev(form, "action", "");
    			add_location(form, file$7, 46, 2, 1304);
    			add_location(span3, file$7, 55, 1, 1578);
    			attr_dev(bloodblaze, "class", "svelte-151gubb");
    			add_location(bloodblaze, file$7, 56, 1, 1588);
    			attr_dev(span4, "class", "inner svelte-151gubb");
    			add_location(span4, file$7, 45, 1, 1280);
    			attr_dev(main, "class", "svelte-151gubb");
    			add_location(main, file$7, 37, 0, 1084);
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Nomination> was created with unknown prop '${key}'`);
    	});
    ...
    class Nomination extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { proceed: 5, blaze: 0, socket: 6 });
    		...
    		if (/*proceed*/ ctx[5] === undefined && !("proceed" in props)) {
    			console_1$1.warn("<Nomination> was created without expected prop 'proceed'");
    		}

    		if (/*blaze*/ ctx[0] === undefined && !("blaze" in props)) {
    			console_1$1.warn("<Nomination> was created without expected prop 'blaze'");
    		}

    		if (/*socket*/ ctx[6] === undefined && !("socket" in props)) {
    			console_1$1.warn("<Nomination> was created without expected prop 'socket'");
    		}
    	}
