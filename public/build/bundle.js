    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$a, 50, 2, 1442);
    			attr_dev(span1, "class", "_2 svelte-1dyam05");
    			add_location(span1, file$a, 51, 2, 1478);
    			attr_dev(h1, "class", "svelte-1dyam05");
    			add_location(h1, file$a, 49, 1, 1433);
    			...
    			add_location(input, file$a, 56, 3, 1613);
    			attr_dev(button, "class", "svelte-1dyam05");
    			add_location(button, file$a, 62, 3, 1799);
    			attr_dev(h3, "class", "svelte-1dyam05");
    			add_location(h3, file$a, 63, 3, 1825);
    ...
    */
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$4, 14, 12, 454);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 8, 8, 270);
    			attr_dev(a, "href", "https://ronald-ronaldmcorona.vercel.app");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$4, 20, 26, 615);
    			add_location(h4, file$4, 19, 12, 583);
    			attr_dev(input0, "type", "hidden");
    			attr_dev(input0, "name", "hosted_button_id");
    			input0.value = "NH4KDT52XGUTN";
    			add_location(input0, file$4, 23, 16, 856);
    			...
    			add_location(input1, file$4, 24, 16, 943);
    			attr_dev(img, "alt", "");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$3, 54, 0, 1645);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class GameRenderer {
        ...
        drawPlayer(p, now, color = '#bba871') {
            ...
            const barrel = 1.8;
            const [x1, y1, x2, y2] = [x + this.playerRadius * dx,
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 26, 1, 900);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-12em62w");
    			add_location(div, file, 19, 0, 724);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
